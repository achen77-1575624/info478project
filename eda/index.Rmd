...
This graph shows the distribution of ethnicity groups and their usage of therapy or counseling at 2 time points during the Covid pandemic. We can see a wide disparity in the Hispanic, Asian, and black populations vs the white population, with `r race_therapy$2020-08-19[2]` percent of the white population haven gotten therapy in August of 2020. However, in January of 2022, this dispairity lessened, as evident by `r race_therapy$2020`Hispanic population 
